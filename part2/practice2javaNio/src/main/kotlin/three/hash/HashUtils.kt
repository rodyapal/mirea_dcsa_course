...
import three.hash.StringUtils.encodeHex
import java.io.File
...
object HashUtils {
	...
	fun getChecksum(digest: MessageDigest, data: String): String {
		val byteArray = updateDigest(digest, data.byteInputStream()).digest()
		val hexCode = encodeHex(byteArray, true)
		return String(hexCode)
	}
